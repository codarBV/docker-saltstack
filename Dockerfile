...
LABEL org.opencontainers.image.title "Saltstack"
LABEL org.opencontainers.image.description "Saltstack with minimal dependencies, based on chainguard"
LABEL org.opencontainers.image.authors "Codar B.V."
LABEL org.opencontainers.image.source "http://github.com/codarBV/docker-saltstack"
LABEL org.opencontainers.image.licenses "Apache2"
LABEL org.opencontainers.image.vendor "codar"
ARG TARGETARCH
ARG VERSION=3.11
USER root
